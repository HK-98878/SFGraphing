...
int main() {
  ...
  sf::RenderWindow window(sf::VideoMode({1600, 800}), "SF-Graphing", sf::Style::Default,
  ...
  std::vector<sf::Color> colors = {sf::Color::Blue, sf::Color::Red, sf::Color::Magenta,
                                   sf::Color::Cyan};
  ...
  while (window.isOpen()) {
    ...
    if (sf::Mouse::isButtonPressed(sf::Mouse::Button::Right)) {
      ...
      sf::Texture texture = sf::Texture({wSize.x, wSize.y});
