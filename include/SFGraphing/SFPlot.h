...
class SFPlot : public sf::Drawable {
   ...
   */
  SFPlot(const sf::Vector2f& position, const sf::Vector2f& dimension, const float& margin,
   ...
   */
  void SetupAxes(const float& xmin, const float& xmax, const float& ymin, const float& ymax,
