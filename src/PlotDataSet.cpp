...
template <>
PlotDataSet::PlotDataSet(const std::vector<float>& xValues, const std::vector<float>& yValues,
...
sf::Color PlotDataSet::GetColor() const { return _color; }

void PlotDataSet::SetColor(const sf::Color& color) { _color = color; }

std::string PlotDataSet::GetLabel() const { return _label; }

void PlotDataSet::SetLabel(const std::string& label) { _label = label; }

PlottingType PlotDataSet::GetPlottingType() const { return _pType; }

void PlotDataSet::SetPlottingType(const PlottingType& type) { _pType = type; }

size_t PlotDataSet::GetDataLength() const { return _xValues.size(); }

std::vector<float> PlotDataSet::GetXValues() const { return _xValues; }

std::vector<float> PlotDataSet::GetYValues() const { return _yValues; }
